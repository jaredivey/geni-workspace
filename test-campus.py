...
for site in IG.aggregates():
    ...
    for i in xrange(0,sn2_switches):
        ...
        r.addResource(createCtrlLink(ctrl,ovs2[i],i+sn0_switches+sn1_switches))
    ...
    r.addResource(ovs4)
    r.addResource(createCtrlLink(ctrl,ovs4,sn0_switches+sn1_switches+sn2_switches+sn3_switches))

    r.addResource(createOvs2OvsLink(ovs4, ovs0[0], subnet, 1))
